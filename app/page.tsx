        ...
        <div className="swiper-wrapper">
          ...
          <div className="swiper-slide">
            <div className="card position-relative p-4 border rounded-3">
              ...
              />
              <h6 className="mt-4 mb-0 fw-bold">
                <a href="index.html">The Story of Success</a>
              </h6>
              <div className="review-content d-flex">
                <p className="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
                <div className="rating text-warning d-flex align-items-center">
      ...
      <div className="swiper testimonial-swiper ">
        <div className="swiper-wrapper">
          ...
          <div className="swiper-slide">
            <div className="card position-relative text-left p-5 border rounded-3">
              <blockquote>
                "As an avid reader, I'm always on the lookout for new releases,
                and this bookstore never disappoints. They always have the
                latest titles, and their recommendations have introduced me to
                some incredible reads!"
              </blockquote>
              <div className="rating text-warning d-flex align-items-center">
                <svg className="star star-fill">
                  <use xlinkHref="#star-fill" />
          ...
          <div className="swiper-slide">
            <div className="card position-relative text-left p-5 border rounded-3">
              <blockquote>
                ...
                laptop, and I couldn't be happier with my experience! The staff
                was incredibly knowledgeable and guided me through the process
                of choosing the perfect device for my needs. Highly
                recommended!”
              </blockquote>
              <div className="rating text-warning d-flex align-items-center">
                <svg className="star star-fill">
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-3 posts mb-4">
          ...
          <p className="mb-2">
            Dive into the world of cutting-edge technology with our latest blog
            post, where we highlight five essential gadge.{" "}
            <span>
              <a
    ...
    <div className="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
      ...
      <div className="offcanvas-body">
        <ul id="navbar"
          className="navbar-nav text-uppercase justify-content-start justify-content-lg-center align-items-start align-items-lg-center flex-grow-1">
          <li className="nav-item">
            <a className="nav-link me-4 active" href="index.html">Home</a>
          </li>
          <li className="nav-item">
            <a className="nav-link me-4" href="index.html">About</a>
          </li>
          <li className="nav-item">
            <a className="nav-link me-4" href="index.html">Shop</a>
          </li>
          <li className="nav-item">
            <a className="nav-link me-4" href="index.html">Blogs</a>
          </li>
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu animate slide border">
              <li>
                <a href="index.html" className="dropdown-item fw-light">About</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Shop</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Single Product</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Cart</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Checkout</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Blog</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Single Post</a>
              </li>
              <li>
                <a href="index.html" className="dropdown-item fw-light">Contact</a>
              </li>
            </ul>
          </li>
          <li className="nav-item">
            <a className="nav-link me-4" href="index.html">Contact</a>
          </li>
        </ul>
        <div className="user-items d-flex">
          <ul className="d-flex justify-content-end list-unstyled mb-0">
            ...
            <li className="cart-dropdown dropdown">
              <a href="index.html" className="dropdown-toggle" data-bs-toggle="dropdown" role="button"
                aria-expanded="false">
                <svg className="cart">
              ...
              <div className="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                ...
                <div className="d-flex flex-wrap justify-content-center">
                  <a href="index.html" className="w-100 btn btn-dark mb-1" type="submit">View Cart</a>
                  <a href="index.html" className="w-100 btn btn-primary" type="submit">Go to checkout</a>
                </div>
              </div>
            </li>
          </ul>
